...
template <typename KeyType, typename ValueType>
inline
int Map<typename KeyType, typename ValueType>::size() const
{
	return m_size;
}
...
template <typename KeyType, typename ValueType>
inline
bool Map<typename KeyType, typename ValueType>::empty() const
{
	return size() == 0;
}
...
template <typename KeyType, typename ValueType>
inline
bool Map<typename KeyType, typename ValueType>::contains(const KeyType& key) const
{
...
template <typename KeyType, typename ValueType>
inline
bool Map<typename KeyType, typename ValueType>::insert(const KeyType& key, const ValueType& value)
{
...
template <typename KeyType, typename ValueType>
inline
bool Map<typename KeyType, typename ValueType>::update(const KeyType& key, const ValueType& value)
{
...
template <typename KeyType, typename ValueType>
inline
bool Map<typename KeyType, typename ValueType>::insertOrUpdate(const KeyType& key, const ValueType& value)
{
